...
|--------|-------------------------------------------------------------|----------------------------------------------------|
| HLSL   | \<not-supported\>                                           |                                                    |
| MSL    | `Tv texturecube.read(uint2 coord, uint face, uint lod = 0)` | `face: [0: +X, 1: -X, 2: +Y, 3: -Y, 4: +Z, 5: -Z]` |
| SPIR-V |                                                             |                                                    |
...
|--------|-------------------------------------------------------------------------------|----------------------------------------------------|
| HLSL   | \<not-supported\>                                                             |                                                    |
| MSL    | `Tv texturecube_array.read(uint2 coord, uint face, uint array, uint lod = 0)` | `face: [0: +X, 1: -X, 2: +Y, 3: -Y, 4: +Z, 5: -Z]` |
| SPIR-V |                                                                               |                                                    |
...
|--------|----------------------------------------------------------|----------|
| HLSL   | \<not-supported\>                                        |          |
| MSL    | `T depthcube.read(uint2 coord, uint face, uint lod = 0)` |          |
| SPIR-V |                                                          |          |
...
|--------|----------------------------------------------------------------------------|----------|
| HLSL   | \<not-supported\>                                                          |          |
| MSL    | `T depthcube_array.read(uint2 coord, uint face, uint array, uint lod = 0)` |          |
| SPIR-V |                                                                            |          |
